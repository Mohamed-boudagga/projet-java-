...
public class QuestionManagerController {
    ...
    private void handleBack() {
        ...
        Games g = new ServiceGames().getById(gameId);
        
        // 2. Récupérer tous les étudiants
        List<String> emails = new ServiceUser().getAllStudentEmails();
        
        // 3. Envoyer la notification automatique à tout le monde (Arrière-plan)
        ...
        ((Stage) txtQuestion.getScene().getWindow()).close();
    }
}
