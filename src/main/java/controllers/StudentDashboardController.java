...
public class StudentDashboardController {
    ...
    private void buildCategories() {
        ...
        categoriesBox.getChildren().add(buildCategoryCard("QUIZ", "#f45b69", "Questions a choix multiples", "Testez vos connaissances Java !"));
        categoriesBox.getChildren().add(buildCategoryCard("CORRECTION DE CODE", "#3a86ff", "Corrigez des bugs Java", "Trouvez et corrigez les erreurs."));
    ...
    private VBox buildCategoryCard(final String name, String color, String subtitle, String hint) {
        ...
        title.setStyle("-fx-font-size: 22; -fx-font-weight: bold; -fx-text-fill: " + color + ";");

        Label sub = new Label(subtitle);
        sub.setStyle("-fx-font-size: 15; -fx-font-weight: bold; -fx-text-fill: #a6b8d4;");
        sub.setWrapText(true);
        sub.setTextAlignment(javafx.scene.text.TextAlignment.CENTER);

        Label hintLabel = new Label(hint);
        hintLabel.setStyle("-fx-font-size: 14; -fx-text-fill: #8090b0;");
    ...
    private VBox buildGameCard(final Games g) {
        ...
        sep.setPrefHeight(1);
        sep.setStyle("-fx-background-color: #1b2a4e;");

        // --- Score max ---
        HBox scoreRow = buildInfoRow("Score max :", g.getScoreMax() + " pts", "white");

        // --- Temps limite ---
        String tempsStr = g.getTimeLimit() > 0 ? g.getTimeLimit() + " sec / question" : "Sans limite";
        HBox timeRow = buildInfoRow("Temps :", tempsStr, "white");
        ...
        descLabel.setStyle("-fx-font-size: 12; -fx-text-fill: #6b82b5;");
    ...
    private HBox buildInfoRow(String key, String value, String valueColor) {
        ...
        k.setStyle("-fx-font-size: 13; -fx-text-fill: #4a6090; -fx-font-weight: bold;");
